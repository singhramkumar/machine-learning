...
def EvalNetwork(inputValues, Network):
    ...
    """
    outputNodeInput = np.empty(3)
    
    # YOUR CODE HERE
    outputNodeInput[0] = Perceptron(Network[0][0],0).activate(inputValues)
    outputNodeInput[1] = Perceptron(Network[0][1],1).activate(inputValues)
    outputNodeInput[2] = Perceptron(Network[0][2],0).activate(inputValues)
    
    OutputValue = Perceptron(Network[1][0],0).activate(outputNodeInput)
    print(OutputValue)
